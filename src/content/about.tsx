  ...
  },
  {
    ...
    description: (
      <Text>
        ...
        design first. From there, data and user feedback will usually dictate
        (and clarify) next steps. If you let people pull product out of you,
        you'll rarely ship anything unnecessary.
      </Text>
    ),
  },
  {
